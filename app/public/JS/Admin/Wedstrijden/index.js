$(document).ready(function () {
    // Load datatables
    let wedstrijdenTable = $('#wedstrijdenTable').DataTable({
        processing: true,
        serverSide: true,
        searching: false,
        info: true,
            ...
            { data: 'score', title: 'Score', render: $.fn.dataTable.render.text() },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (row.deleted_at === null) {
                        deletedAt = `
                            <form method="POST" action="/admin/wedstrijden/${row.id}" class="d-inline delete-form">
                        ...
                        deletedAt = `
                            <form method="POST" action="/admin/wedstrijden/${row.id}/force" class="d-inline force-delete-form">
                                <input type="hidden" name="_method" value="DELETE">
