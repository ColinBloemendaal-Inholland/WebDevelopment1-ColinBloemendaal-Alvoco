            ...
            { data: 'role', title: 'Rol', render: $.fn.dataTable.render.text() },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (row.deleted_at === null) {
                        deletedAt = `
                            <form method="POST" action="/admin/trainers/${row.id}" class="d-inline delete-form">
                        ...
                        deletedAt = `
                            <form method="POST" action="/admin/trainers/${row.id}/force" class="d-inline force-delete-form">
                                <input type="hidden" name="_method" value="DELETE">
