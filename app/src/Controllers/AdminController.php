...
class AdminController
{
    ...
    function storeLeden(array $params)
    {
        $errors = [];
        $data = [];
    ...
    function updateLeden(array $params)
    {
        $id = intval($params['id']);
        ...
        // Required fields (password optional on update)
        $requiredFields = [
            'firstname',
            'lastname',
            'gender',
        ...
        // Password confirmation (only if user entered a new password)
        ...
        if (!empty($data['password'])) {
            $lidData['password'] = password_hash($data['password'], PASSWORD_DEFAULT);
        }
