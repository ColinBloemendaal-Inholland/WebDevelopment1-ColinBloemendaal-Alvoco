                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="/contact">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="bericht" id="bericht" class="form-control" rows="5" required
                                    aria-label="Bericht invoerveld"><?= e($_SESSION['form_old']['bericht'] ?? '') ?></textarea>
                            </div>
                            <div class="d-grid">
