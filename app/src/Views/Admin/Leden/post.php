...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="edit.php?id=<?= $data['lid']['id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                <a href="delete.php?id=<?= $data['lid']['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
            </div>
        </div>
