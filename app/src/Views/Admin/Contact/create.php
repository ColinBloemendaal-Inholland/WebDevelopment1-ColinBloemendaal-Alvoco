<div class="d-flex flex-grow-1">
    ...
    <div class="flex-grow-1 p-4">
        <div class="container-fluid m-0 py-5">
            <div class="row">
                <div class="col-12">
                    <h2 class="h4 mb-4">Nieuw Contact toevoegen</h2>
                            ...
                            <form method="POST">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="bestuurslid_id" id="bestuurslid_id" class="form-select" required>
                                            ...
                                            <?php foreach ($data['bestuursleden'] as $lid): ?>
                                                <option value="<?= e($lid['id']) ?>" <?= (isset($_SESSION['form_old']['bestuurslid_id']) && $_SESSION['form_old']['bestuurslid_id'] == $lid['id']) ? 'selected' : '' ?>>
                                                    <?= e($lid['fullname']) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-sm-9 offset-sm-3">
                                        ...
                                        <a href="/admin/contact" class="btn btn-secondary">Annuleren</a>
                                    </div>
                                </div>
                            </form>
                        </div>
