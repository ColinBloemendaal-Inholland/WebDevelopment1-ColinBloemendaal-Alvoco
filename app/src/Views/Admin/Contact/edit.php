                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/admin/contact/<?= $data['contact']['id'] ?>">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="naam" name="naam" value="<?= e($_SESSION['form_old']['naam'] ?? $data['contact']['naam']) ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="email" class="col-sm-3 col-form-label">Email</label>
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="email" name="email" value="<?= e($_SESSION['form_old']['email'] ?? $data['contact']['email']) ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="bericht" class="col-sm-3 col-form-label">Bericht</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="bericht" name="bericht" required><?= e($_SESSION['form_old']['bericht'] ?? $data['contact']['bericht']) ?></textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
