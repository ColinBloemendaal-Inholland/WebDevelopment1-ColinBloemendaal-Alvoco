                            ...
                            <form method="POST" action="/admin/contact/<?= $data['contact']['id'] ?>">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="naam" name="naam"
                                            value="<?= e($_SESSION['form_old']['naam'] ?? $data['contact']['naam']) ?>"
                                            required aria-label="Naam invoerveld">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="email" name="email"
                                            value="<?= e($_SESSION['form_old']['email'] ?? $data['contact']['email']) ?>"
                                            required aria-label="E-mail invoerveld">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="bericht" class="col-sm-3 col-form-label">Bericht</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="bericht" name="bericht" required
                                            aria-label="Bericht invoerveld"><?= e($_SESSION['form_old']['bericht'] ?? $data['contact']['bericht']) ?></textarea>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                        ...
                                        <select name="bestuurslid_id" id="bestuurslid_id" class="form-select" required>
                                            ...
                                            <?php foreach ($data['bestuursleden'] as $lid): ?>
                                                <option value="<?= e($lid['id']) ?>"
                                                    <?= (isset($_SESSION['form_old']['bestuurslid_id']) && $_SESSION['form_old']['bestuurslid_id'] == $lid['id']) ? 'selected' : ($data['contact']['bestuurslid_id'] == $lid['id'] ? 'selected' : '') ?>>
                                                    <?= e($lid['fullname']) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-sm-9 offset-sm-3">
                                        ...
                                        <a href="/admin/contact/<?= e($data['contact']['id']) ?>"
