    ...
    <main class="flex-grow-1 p-4">
        <section class="container m-0 py-5">
            <div class="row">
                <div class="col-12">
                    <header>
                        <h2 class="h4 mb-4">Bewerk Coach</h2>
                    </header>
                    <article class="card shadow-sm">
                        <div class="card-body">
                            <?php \View::partial('Layout.errors'); ?>
                            <form method="POST" action="/admin/coaches/<?= $data['coach']['id'] ?>">
                                <!-- Simulate PUT method -->
                                            ...
                                            <?php foreach ($data['leden'] as $lid): ?>
                                                <option value="<?= e($lid['id']) ?>"
                                                    <?= (isset($_SESSION['form_old']['Leden_id']) && $_SESSION['form_old']['Leden_id'] == $lid['id'])
                                                        ? 'selected'
                                                        : ($data['coach']['Leden_id'] == $lid['id'] ? 'selected' : '') ?>>
                                                    <?= e($lid['fullname']) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="role" name="role"
                                            ...
                                            value="<?= e($_SESSION['form_old']['role'] ?? $data['coach']['role']) ?>"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" id="start_date" name="start_date"
                                            ...
                                            value="<?= e($_SESSION['form_old']['start_date'] ?? $data['coach']['start_date']) ?>"
                                            required>
                                    </div>
                                </div>
                                            ...
                                            <?php foreach ($data['teams'] as $team): ?>
                                                <option value="<?= e($team['id']) ?>"
                                                    <?= (isset($_SESSION['form_old']['team_id']) && $_SESSION['form_old']['team_id'] == $team['id'])
                                                        ? 'selected'
                                                        : ($data['coach']['team_id'] == $team['id'] ? 'selected' : '') ?>>
                                                    <?= e($team['name']) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-sm-9 offset-sm-3">
                                        ...
                                        <a href="/admin/coaches/<?= e($data['coach']['id']) ?>"
...
<script src="/JS/Admin/Coaches/edit.js"></script>
