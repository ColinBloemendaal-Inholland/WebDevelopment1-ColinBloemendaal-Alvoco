<div class="d-flex flex-grow-1">
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="/admin/leden/<?= $data['trainer']['lid']['id'] ?>" class="btn btn-primary btn-sm">Bekijk lid</a>
                <a href="edit.php?id=<?= $data['trainer']['id'] ?>" class="btn btn-primary btn-sm">Bewerken</a>
                <a href="delete.php?id=<?= $data['trainer']['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Weet je het zeker?')">Verwijderen</a>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-9"><?= e($data['trainer']['team']['name'] ?? 'Niet toegewezen') ?></dd>
